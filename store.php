...
<html>
    ...
    <body>
        ...
        <section class="container content-section">
            <h2 class="section-header">English</h2>
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">The Norton Anthology of English Literature: The Major Authors: Volume 2</span>
                    <img class="shop-item-image" src="images/books/NAEL.jpg">
                    <div class="shop-item-details">
        ...
        <section class="container content-section">
            <h2 class="section-header">Foreign Language</h2>
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Exploraciones</span>
                    <img class="shop-item-image" src="images/books/Exploraciones.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$19.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Charity & Sylvia: A Same-Sex Marriage in Early America</span>
                    <img class="shop-item-image" src="images/books/Char&Sylv.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$19.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
        ...
        <section class="container content-section">
            <h2 class="section-header">Information Security</h2>
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Computer Security Fundamentals</span>
                    <img class="shop-item-image" src="images/books/CompSecFun.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$19.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Discrete Mathematics and Its Applications</span>
                    <img class="shop-item-image" src="images/books/Discrete.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$19.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
            ...
            <div class="shop-items">
                <div class="shop-item">
                    ...
                    <img class="shop-item-image" src="images/books/EssentialCalc.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$19.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
            ...
            <div class="shop-items">
                <div class="shop-item">
                    ...
                    <img class="shop-item-image" src="images/books/IntroStats.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$19.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
        ...
        <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">The Enjoyment of Music</span>
                    <img class="shop-item-image" src="images/books/EnjoyMusic.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$19.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
        ...
        <section class="container content-section">
            <h2 class="section-header">Physics</h2>
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Physics: Principles with Applications</span>
                    <img class="shop-item-image" src="images/books/Physics.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$19.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
         ...
         <section class="container content-section">
            <h2 class="section-header">Psychology</h2>
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Psychological Science</span>
                    <img class="shop-item-image" src="images/books/PsychSci.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$19.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
        ...
        <section class="container content-section">
            <h2 class="section-header">Religion</h2>
            <div class="shop-items">
                <div class="shop-item">
                    <span class="shop-item-title">Church History 101: A Concise Overview</span>
                    <img class="shop-item-image" src="images/books/ChurchHist.jpg">
                    <div class="shop-item-details">
                        <span class="shop-item-price">$19.99</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
